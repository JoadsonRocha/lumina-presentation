...
- Botão **Limpar Apresentação (🗑️)** com confirmação de segurança para recomeçar quando desejado.
...
Este projeto está licenciado sob a licença GNU General Public License v3.0 (GPLv3) - consulte o arquivo [LICENSE](LICENSE) para mais detalhes.
